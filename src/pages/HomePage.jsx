...
import { Play, Activity, DollarSign, Zap, User, BookOpen, Database } from 'lucide-react';
    ...
    return (
        <div className="min-h-[calc(100vh-200px)] flex items-center justify-center fade-in">
            <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="md:col-span-2 space-y-8">
                    ...
                    <div className="glass-panel p-12 rounded-3xl relative overflow-hidden">
                        <div className="flex flex-col md:flex-row items-center gap-8">
                            ...
                            >
                                <div
                                    className="w-32 h-32 rounded-full bg-slate-800 border-4 border-indigo-400 flex items-center justify-center shadow-2xl hover:scale-110 transition-transform overflow-hidden"
                                >
                            ...
                            <div className="flex-1 text-center md:text-left">
                                <h1 className="text-5xl md:text-6xl font-bold text-white tracking-tight mb-3">
                                    Welcome Back, <span className="text-indigo-400">{state.username}</span>
                                </h1>
                ...
                {/* Right Side: Play and Navigations */}
                <div className="md:col-span-1 space-y-6 flex flex-col justify-center items-center">
                    {/* CTA Button */}
                    ...
                    <div className="flex flex-col gap-3 w-full max-w-xs">
                        <button
                            onClick={() => navigate('/profile')}
                            className="flex items-center gap-3 px-6 py-4 bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-white rounded-lg transition-all border border-slate-700 w-full"
                        >
                        ...
                        >
                            ...
                            <span className="text-md font-semibold">Databank</span>
                        </button>
                        <button
                        ...
                        >
                            ...
                            <span className="text-md font-semibold">Manual</span>
                        </button>
                    </div>
                </div>
            </div>
